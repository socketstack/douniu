...
//    public static String addUserWithOpenid = "http://localhost:8081/addUser.do?openid=OPENID&name=NAME&imgUrl=IMG_URL";
    ...
    public static String addUserWithOpenidUrl = "http://139.129.98.110:8090/game_service/addUser.do";
    public static String addUserWithOpenidParam = "openid=OPENID&name=NAME&imgUrl=IMG_URL&unionid=UNIONID";
